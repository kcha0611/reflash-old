    ...
    return (
      <div className="pic-index-wrap">
        <div className="tab-wrap">
          <img id="normal-tab" onClick={this.handleNormalTab} src="https://res.cloudinary.com/dllnnnotc/image/upload/c_scale,w_34/v1477014487/mobile_menu_icon_zdz8sw.png"/>
          <img id="grid-tab" onClick={this.handleGridTab} src="https://res.cloudinary.com/dllnnnotc/image/upload/c_scale,w_25/v1477014279/256-256-43252f44e69ebdd2e8bb5370ba120db4-grid_buzr3h.png"/>
        </div>
