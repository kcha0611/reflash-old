        ...
        <div className="collections-wrap">
          <div className="inner-collections-wrap">
            <div className="first-collection-wrap">
              ...
              <img src="https://res.cloudinary.com/dllnnnotc/image/upload/v1474935416/1920x1080_e1aoab.jpg" className="first-collection-img" id="collection-img" onClick={this.goFirstUser}/>
            </div>
            <div className="second-collection-wrap">
              ...
              <img src="https://res.cloudinary.com/dllnnnotc/image/upload/v1474935395/1920x1080_a0vlgw.jpg" className="second-collection-img" id="collection-img" onClick={this.goSecondUser}/>
            </div>
          </div>
          <div className="three-collection-wrap">
            <div className="third-collection-wrap">
              ...
              <img src="https://res.cloudinary.com/dllnnnotc/image/upload/c_scale,h_1080,w_1920/v1477524693/nature_ayqyoq.jpg" className="third-collection-img" id="collection-img" onClick={this.goThirdUser}/>
            </div>
            <div className="fourth-collection-wrap">
              ...
              <img src="https://res.cloudinary.com/dllnnnotc/image/upload/c_scale,h_1080,w_1920/v1477524681/nature_fznpry.jpg" className="fourth-collection-img" id="collection-img" onClick={this.goFourthUser}/>
            </div>
            <div className="fifth-collection-wrap">
              ...
              <img src="https://res.cloudinary.com/dllnnnotc/image/upload/c_scale,h_1080,w_1920/v1477524677/nature_dcomfs.jpg" className="fifth-collection-img" id="collection-img" onClick={this.goFifthUser}/>
            </div>
          </div>
        </div>
      </div>
